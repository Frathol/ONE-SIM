...
public class SimScenario implements Serializable {
	...
	protected SimScenario() {
		// Ambil semua key dengan prefix Scenario.
		...
		// Validasi agar simulasi waktu tidak negatif
		...
		// event eksternal (MessageEventGenerator) masuk lewat eqHandler
		this.eqHandler = new EventQueueHandler();

		/* TODO: check size from movement models */
		// World size punya movement bukan scenario
	 ...
	 */
	// Dalam 1 simulasi cuma ada 1 scenario dan CFG dibaca sekali di awal
	...
	protected void createHosts() {
		...
		for (int i=1; i<=nrofGroups; i++) {
			...
			// PENTING karena createIntializedObject itu manggil constructor 

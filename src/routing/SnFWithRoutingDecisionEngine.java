 ...
 */
public class SnFWithRoutingDecisionEngine implements RoutingDecisionEngine {
    ...
    public SnFWithRoutingDecisionEngine(Settings s) {
    ...
    public SnFWithRoutingDecisionEngine(SnFWithRoutingDecisionEngine snf) {
    ...
    public RoutingDecisionEngine replicate() {
        return new SnFWithRoutingDecisionEngine(this);
    }
    ...
    // This method should be called once for each connection that comes up to give two decision engine
    public void doExchangeForNewConnection(Connection con, DTNHost peer) {
        SnFWithRoutingDecisionEngine de = this.getOtherSnFDecisionEngine(peer);
    ...
    // This method will be called after a message is sent to some other peer to ask if it should now be deleted from the message store
    ...
    // This method will be called when a new message is received at a given router to determine if it should be saved and further forwarded on
    public boolean shouldSaveReceivedMessage(Message m, DTNHost thisHost) {
        return m.getTo() != thisHost;
    }

    // This method will be called periodically to allow the decision engine to update its internal state
    public boolean shouldSendMessageToHost(Message m, DTNHost otherHost) {
        ...
        SnFWithRoutingDecisionEngine de = this.getOtherSnFDecisionEngine(otherHost);
    ...
    private SnFWithRoutingDecisionEngine getOtherSnFDecisionEngine(DTNHost h) {
        MessageRouter otherRouter = h.getRouter();
        assert otherRouter instanceof DecisionEngineRouter : "This router only works " +
                " with other routers of same type";

        return (SnFWithRoutingDecisionEngine) ((DecisionEngineRouter) otherRouter).getDecisionEngine();
    }

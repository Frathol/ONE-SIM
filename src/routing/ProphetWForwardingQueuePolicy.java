 ...
 */
public class ProphetWForwardingQueuePolicy extends UniversalQueueRouter {
  ...
  // Setting ID Forwarding
  public static final String FORWARD_STRAT_S = "forwardStrategy";
  public static final String STRAT_GRTR = "GRTR";
  public static final String STRAT_GRTR_SORT = "GRTRSort";
  public static final String STRAT_GRTR_MAX = "GRTRMax";

  private String currentForwardStrategy;
   ...
   */
  public ProphetWForwardingQueuePolicy(Settings s) {
    super(s);
    Settings prophetSettings = new Settings(PROPHET_NS);
    secondsInTimeUnit = prophetSettings.getInt(SECONDS_IN_UNIT_S);
    beta = prophetSettings.contains(BETA_S) ? prophetSettings.getDouble(BETA_S) : DEFAULT_BETA;

    if (prophetSettings.contains(FORWARD_STRAT_S)) {
      currentForwardStrategy = prophetSettings.getSetting(FORWARD_STRAT_S);
    } else {
      currentForwardStrategy = STRAT_GRTR_MAX;
    }
   ...
   */
  protected ProphetWForwardingQueuePolicy(ProphetWForwardingQueuePolicy r) {
    super(r);
  ...
  private void updateTransitivePreds(DTNHost host) {
    ...
    assert otherRouter instanceof ProphetWForwardingQueuePolicy : "PRoPHET only works " +
        " with other routers of same type";

    double pForHost = getPredFor(host); // P(a,b)
    Map<DTNHost, Double> othersPreds = ((ProphetWForwardingQueuePolicy) otherRouter).getDeliveryPreds();
  ...
  private Tuple<Message, Connection> tryOtherMessages() {
    ...
    for (Connection con : getConnections()) {
      ...
      ProphetWForwardingQueuePolicy othRouter = (ProphetWForwardingQueuePolicy) other.getRouter();
  ...
  /**
   * Comparator untuk mendukung 3 strategi forwarding
   */
  ...
  protected double getPredictabilityToDestination(DTNHost dest) {
    // Menghubungkan logika LEPR ke tabel Prophet
  ...
  @Override
  public ProphetWForwardingQueuePolicy replicate() {
    ProphetWForwardingQueuePolicy r = new ProphetWForwardingQueuePolicy(this);
    return r;
  }

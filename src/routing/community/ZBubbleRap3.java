...
public class ZBubbleRap3 implements RoutingDecisionEngine, CommunityDetectionEngine, CentralityDetectionEngine {
  ...
  public ZBubbleRap3(ZBubbleRap3 proto) {
  ...
  public void doExchangeForNewConnection(Connection con, DTNHost peer) {
    ...
    ZBubbleRap3 de = this.getOtherDecisionEngine(peer);
  ...
  public boolean shouldSendMessageToHost(Message m, DTNHost otherHost, DTNHost thisHost) {
    ...
    ZBubbleRap3 de = getOtherDecisionEngine(otherHost);
  ...
  public boolean shouldDeleteSentMessage(Message m, DTNHost otherHost) {
    ...
    ZBubbleRap3 de = this.getOtherDecisionEngine(otherHost);
  ...
  private ZBubbleRap3 getOtherDecisionEngine(DTNHost h) {
    MessageRouter otherRouter = h.getRouter();
    assert otherRouter instanceof DecisionEngineRouter : "This router only works "
        + " with other routers of same type";

    return (ZBubbleRap3) ((DecisionEngineRouter) otherRouter).getDecisionEngine();
  }

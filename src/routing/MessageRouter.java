...
//        }
     ...
     */
    // Dipanggil oleh DTNHost saat ada perubahan koneksi (Koneksi UP/DOWN)
    ...
    public void sendMessage(String id, DTNHost to) {
        ...
        // Kirim pesan (replicate) ke host tujuan, pesan asli tetap di buffer
        m2 = m.replicate();	// send a replicate of the message
        // Tambahkan this host ke path pesan
    ...
    public int receiveMessage(Message m, DTNHost from) {
        ...
        // Belum dimasukkan ke buffer pesan, itu dilakukan saat transfer selesai 
